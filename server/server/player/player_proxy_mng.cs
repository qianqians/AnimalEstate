...
namespace player
{
    class player_proxy
    {
        ...
        public player_proxy(player_player_room_caller caller, hub.hubproxy proxy)
        {
        ...
        {
            player_Player_Room_Caller.get_hub(name).invite_role_join_room(sdk_uuid, invite_role_name);
        }
    }
    ...
    class player_proxy_mng
    {
        ...
        {
            player_proxys.Add(_proxy.name, new player_proxy(_player_player_room_caller, _proxy));
        }
