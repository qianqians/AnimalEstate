...
namespace player
{
    ...
    {
        private abelkhan.player_login_module player_login_Module;

        public client_msg_handle()
        {
            player_login_Module = new abelkhan.player_login_module();
        ...
        private void Player_login_Module_on_create_role(string name)
        {
            ...
            var rsp = player_login_Module.rsp as abelkhan.player_login_create_role_rsp;
        ...
        private void Login_Player_Module_on_player_login(string token)
        {
            ...
            var rsp = player_login_Module.rsp as abelkhan.player_login_player_login_rsp;
            var uuid = hub.hub._gates.current_client_uuid;
